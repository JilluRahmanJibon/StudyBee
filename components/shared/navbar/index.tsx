...
const Navbar = () => {
  ...
  const NavbarAPI: NavbarAPIType = [
    { id: 1, navName: "Home", link: "/" },
    {
      ...
      navName: "Courses",
      subNav: [
        { id: 1, navName: "Batch Schedule", link: "/example" },
        { id: 2, navName: "Course Fees", link: "/example" },
        { id: 3, navName: "IELTS", link: "/example" },
        { id: 4, navName: "Spoken English", link: "/example" },
        { id: 5, navName: "Advanced Writing", link: "/example" },
        { id: 6, navName: "Grammar & Writing", link: "/example" },
        { id: 7, navName: "After SSC English", link: "/example" },
        { id: 8, navName: "GED", link: "/example" },
        { id: 9, navName: "IBA-BBA", link: "/example" },
        { id: 10, navName: "IBA-MBA", link: "/example" },
        { id: 11, navName: "Kid's English", link: "/example" },
        { id: 12, navName: "PTE", link: "/example" },
        { id: 13, navName: "SAT", link: "/example" },
      ],
    },
    {
      id: 3,
      ...
      subNav: [
        {
          ...
          navName: "IELTS",
          secondSubNav: [
            { id: 1, navName: "Kalabagan", link: "/example55" },
            { id: 2, navName: "Uttara - 1", link: "/example" },
            { id: 3, navName: "Uttara - 2", link: "/example" },
            { id: 4, navName: "Mirpur", link: "/example" },
            { id: 5, navName: "Banani", link: "/example" },
            { id: 6, navName: "Wari", link: "/example" },
          ],
        },
        {
          id: 2,
          navName: "GED",
          secondSubNav: [
            { id: 1, navName: "Kalabagan", link: "/example" },
            { id: 2, navName: "Chittagong", link: "/example" },
          ],
        },
        {
          id: 3,
          navName: "PTE",
          secondSubNav: [{ id: 1, navName: "Chittagong", link: "/example" }],
        },
      ],
    },
    {
      ...
      subNav: [
        { id: 1, navName: "Course Finder", link: "/example" },
        { id: 2, navName: "USA", link: "/example" },
        { id: 3, navName: "Australia", link: "/example" },
        { id: 4, navName: "Malaysia", link: "/example" },
        { id: 5, navName: "UK", link: "/example" },
        { id: 6, navName: "Canada", link: "/example" },
        { id: 7, navName: "Japan", link: "/example" },
        { id: 8, navName: "New Zealand", link: "/example" },
        { id: 9, navName: "Sweden", link: "/example" },
        { id: 10, navName: "Denmark", link: "/example" },
        { id: 11, navName: "Ireland", link: "/example" },
      ],
    },
    {
      id: 5,
      ...
      subNav: [
        { id: 1, navName: "Live Courses", link: "/livecourses" },
        { id: 2, navName: "Tests", link: "/example" },
        { id: 3, navName: "Recorded Courses", link: "/example" },
      ],
    },
  ];
