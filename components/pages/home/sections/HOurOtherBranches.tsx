...
const OurOtherBranches = () => {
  ...
  return (
    <div>
      ...
      <section
        id="OurOtherBranches"
        className="xl:w-[1199px]! lg:w-[960px]! md:w-[720px] sm:w-[510px] w-full mx-auto h-auto px-[15px] lg:pt-[70px] pt-[50px] font-poppins! lg:pb-[85px] pb-[50px]"
      >
        <div
          className={`w-full flex justify-center text-center xl:mb-10 mb-[30px]`}
        >
        ...
        <main className="w-full flex flex-wrap sm2:gap-[25px] gap-5 justify-center">
          {OurOtherBranchesData.map((card) => {
            return (
              <div
                key={card.id}
                className="sm3:w-[365px] w-full bg-white text-[#000000d1]! hover:-translate-y-2 shadow-[0px_0px_8px_0px_#00000014] group sm2:p-[25px] p-[15px] rounded-[15px] transition-all duration-1000"
              >
                <h1 className="sm2:text-[21px] text-[17px] text-[#000000d1]! font-normal font-poppins mb-[7px]">
                  {card.title}
                </h1>

                <div className="flex mb-[7px]">
                  <div className="sm2:w-[19px] w-[17px] sm2:min-w-[19px] min-w-[17px] pt-1">
                    <MdOutlineShareLocation className="sm2:text-[18px] text-[14px] text-primaryHover -mt-0.5" />
                  </div>
                  <p className="sm2:text-[14px] text-[13px]">{card.location}</p>
                </div>
                <div className="flex items-center mb-[7px]">
                  <div className="sm2:w-[19px] w-[17px] sm2:min-w-[19px] min-w-[17px]">
                    <IoBookOutline className="sm2:text-[15px] text-[13px] text-primaryHover" />
                  </div>
                  <p className="sm2:text-[14px] text-[13px]">
                    <span className="font-medium mr-[5px]">Education:</span>
                    {card.education}
                  </p>
                </div>
                <div className="flex items-center">
                  <div className="sm2:w-[19px] w-[17px] sm2:min-w-[19px] min-w-[17px]">
                    <HiOutlineMail className="sm2:text-[17px] text-[15px] text-primaryHover -ml-px" />
                  </div>
                  <p className="sm2:text-[14px]! text-[13px]">
                    <span className="font-medium mr-[5px]">Email:</span>
                    {card.email}
                  </p>
                </div>
              </div>
