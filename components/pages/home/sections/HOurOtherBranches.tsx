...
const OurOtherBranches = () => {
  ...
  return (
    <div>
      {/* Our Other Branches */}
      <section className="xl:w-[1199px]! lg:w-[960px]! md:w-[720px] sm:w-[510px] w-full mx-auto h-auto px-[15px] lg:pt-[70px] pt-[50px] font-poppins! lg:pb-[85px] pb-[50px]">
        ...
        <main className="w-full flex flex-wrap sm2:gap-[30px] gap-5 justify-center">
            ...
            return (
              ...
              >
                <div className="w-full h-full text-[#000000d1]! group-hover:text-white! bg-white group-hover:bg-transparent sm2:p-[25px] p-[15px] rounded-[13px] transition-all duration-1000">
                  <h1 className="sm2:text-[21px] text-[17px] text-[#000000d1]! group-hover:text-white! font-medium font-poppins mb-[7px] transition-all duration-1000">
                    {card.title}
                  </h1>

                  <div className="flex mb-[7px]">
                    <div className="sm2:w-[19px] w-[17px] sm2:min-w-[19px] min-w-[17px] pt-1">
                      <FaLocationDot className="sm2:text-[16px] text-[13px]" />
                    </div>
                    <p className="sm2:text-[15px] text-[13px] group-hover:text-[#ffffffd7]! transition-all duration-1000">
                      {card.location}
                    </p>
                  </div>
                  <div className="flex items-center mb-[7px]">
                    <div className="sm2:w-[19px] w-[17px] sm2:min-w-[19px] min-w-[17px]">
                      <FaBookOpen className="sm2:text-[15px] text-[13px]" />
                    </div>
                    <p className="sm2:text-[15px] text-[13px] group-hover:text-[#ffffffd7]! transition-all duration-1000">
                  ...
                  <div className="flex items-center">
                    <div className="sm2:w-[19px] w-[17px] sm2:min-w-[19px] min-w-[17px]">
                      <MdEmail className="sm2:text-[17px] text-[15px] -ml-px" />
                    </div>
                    <p className="sm2:text-[15px] text-[13px] group-hover:text-[#ffffffd7]! transition-all duration-1000">
                      <span className="group-hover:text-[#ffffffd7]! font-medium mr-[5px] transition-all duration-1000">
                        Email:
